        ...
        <div class="row">
          <div class="col-md-6">
            <form-auto
              ...
              title="Nama"
              read
              v-model="ubah_mutasi_keluar.nama_pejabat_persetujuan"
            ></form-auto>
          </div>
          <div class="col-md-6">
            <form-auto
              ...
              title="NIP"
              read
              v-model="ubah_mutasi_keluar.nip_pejabat_persetujuan"
            ></form-auto>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <form-auto
              ...
              title="Pangkat"
              read
              v-model="ubah_mutasi_keluar.pangkat_pejabat_persetujuan"
            ></form-auto>
          </div>
          <div class="col-md-6">
            <form-auto
              ...
              read
              v-model="ubah_mutasi_keluar.golongan_ruang_pejabat_persetujuan"
            ></form-auto>
          </div>
          <div class="col-md-6">
            <form-auto
              ...
              title="Jabatan"
              read
              v-model="ubah_mutasi_keluar.jabatan_pejabat_persetujuan"
            ></form-auto>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <form-auto
                ...
                :kelasform="$message.kelas.big"
                title="Nomor Surat"
                v-model="ubah_mutasi_keluar.no_surat_perny_pers"
              ></form-auto>
            </div>
            <div class="col-md-6">
              <form-auto
                ...
                :kelasform="$message.kelas.big"
                title="Tanggal Surat"
                v-model="ubah_mutasi_keluar.tanggal_surat_perny_pers"
              ></form-auto>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <form-auto
                ...
                v-model="ubah_mutasi_keluar.jabatan_ppk_instansi_penerima1"
              ></form-auto>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <form-auto
                ...
                :kelasform="$message.kelas.big"
                title="Nomor Surat"
                v-model="ubah_mutasi_keluar.no_surat_pengantar_perny_pers"
              ></form-auto>
            </div>
            <div class="col-md-6">
              <form-auto
                ...
                :kelasform="$message.kelas.big"
                title="Tanggal Surat"
                v-model="ubah_mutasi_keluar.tanggal_surat_pengantar_perny_pers"
              ></form-auto>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <form-auto
            ...
            title="Nama"
            read
            v-model="ubah_mutasi_keluar.nama_pegawai"
          ></form-auto>
        </div>
        <div class="col-md-6">
          <form-auto
            ...
            title="NIP"
            read
            v-model="ubah_mutasi_keluar.nip"
          ></form-auto>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <form-auto
            ...
            title="Pangkat"
            read
            v-model="ubah_mutasi_keluar.pangkat"
          ></form-auto>
        </div>
        <div class="col-md-6">
          <form-auto
            ...
            title="Golongan Ruang"
            read
            v-model="ubah_mutasi_keluar.golongan_ruang"
          ></form-auto>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <form-auto
            ...
            title="Jabatan"
            read
            v-model="ubah_mutasi_keluar.jabatan"
          ></form-auto>
        </div>
        <div class="col-md-6">
          <form-auto
            ...
            title="Unit Kerja"
            read
            v-model="ubah_mutasi_keluar.unit_kerja"
          ></form-auto>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <form-auto
            ...
            :kelasform="$message.kelas.big"
            title="Instansi Penerima"
            v-model="ubah_mutasi_keluar.jabatan_ppk_instansi_penerima2"
          ></form-auto>
        </div>
      </div>
      <div>
        ...
        <div class="row">
          <div class="col-md-6">
            <form-auto
              ...
              :kelasform="$message.kelas.big"
              title="Nomor Surat"
              v-model="ubah_mutasi_keluar.no_spp"
            ></form-auto>
          </div>
          <div class="col-md-6">
            <form-auto
              ...
              :kelasform="$message.kelas.big"
              title="Tanggal Surat"
              v-model="ubah_mutasi_keluar.tanggal_spp"
            ></form-auto>
          </div>
        </div>
        <div class="row">
...
export default {
  ...
  methods: {
    ...
    //     .then((results) => {
    //       alert("data diterima");
    //       this.ubah_mutasi_keluar = results.data;
    //     })
    //     .catch((err) => {
    ...
    //   Axios.put(url + id, this.ubah_mutasi_keluar)
    //     .then((results) => {
