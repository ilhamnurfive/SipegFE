    ...
    <CCardBody>
      <div class="container-fluid">
        ...
        <div class="text-right btn-tambah">
          <button class="btn btn-success">{{ $message.button.tampilkan }}</button>
        </div>
      </div>
      ...
      <router-link class="float-right" :to="{ name: 'form-usul-ja' }">
        <button class="btn btn-outline-success">{{ $message.button.tambah }} Usul</button>
      </router-link>
    </CCardBody>
    <!-- Modal Unggah -->
    <div>
