        ...
        <template #aksi="{item,index}">
          <td v-if="!editNilai">
            <b-dropdown class="ye" size="sm" variant="light" toggle-class="text-decoration-none">
              ...
              <CDropdownItem @click="routeDropdown('ubah-peserta-udin')">
              ...
              <CDropdownItem @click="routeDropdown('cetak-sk-udin')">
